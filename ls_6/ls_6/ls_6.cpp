// ls_5.cpp : Определяет точку входа для приложения.
//
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LS6, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LS6));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LS6));
