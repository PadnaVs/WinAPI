                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LS5, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LS5));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
        ...
        shar.setCoordsStart(wWindow/2, hWindow/2);
        break;
    case WM_LBUTTONUP:
        xMove = LOWORD(lParam);
        yMove = HIWORD(lParam);
